...
<div class="px-4 py-6 sm:px-0">
	<div class="mb-8">
		...
		<h1 class="text-2xl font-bold text-gray-900 mt-4">Crear Nuevo Usuario</h1>
	...
	<div class="max-w-2xl">
		...
		>
						...
						<div>
							...
							<div class="mt-1 relative">
								<input
									...
									required
									minlength="6"
									class="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm pr-10"
			...
			<div class="bg-white shadow sm:rounded-lg">
				<div class="px-4 py-5 sm:p-6">
					<h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Rol y Estado</h3>
			...
			<div class="flex justify-end space-x-3">
				...
				<button
					...
					class="rounded-md border border-transparent bg-green-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
				>
					{#if isSubmitting}
